...
// Bullish Engulfing Pattern Recognizer class
public ref class BullishEngulfingRecognizer : PatternRecognizer {
public:
    ...
    // Checks if a Bullish Engulfing pattern is present at the specified position
    ...
    // Returns the range of indices forming the Bullish Engulfing pattern
